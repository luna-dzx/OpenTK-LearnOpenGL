...
void main()
{
    ...
    else
    {
        ...
        vec3 phong = lx_Phong(normal, fs_in.TBNfragPos, fs_in.TBNcameraPos, fs_in.texCoords, material, lx_MoveLight(light,fs_in.TBNlightPos), 1.0);
        lx_FragColour = lx_Colour(phong);
    }
    
    //lx_FragColour = texture(material.specTex,fs_in.texCoords);
