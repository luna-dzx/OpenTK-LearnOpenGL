...
public class Game1 : Library.Game
{
    ...
    protected override void Load()
    {
        ...
        shaderProgram.Uniform("inputColour");
        shaderProgram2.SyncUniform("triangleXpos",this);
    ...
    protected override void RenderFrame(FrameEventArgs args)
    {
        ...
        shaderProgram2.UpdateSyncedUniforms(this);
        
        
        // draw green wireframe rect
        shaderProgram.Use(); GL.PolygonMode(MaterialFace.FrontAndBack,PolygonMode.Line);
        GL.Uniform3(shaderProgram.GetUniform("inputColour"),0f,greenValue,0f);
        vao1.Use();
